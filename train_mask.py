...
def model_define():
    ...
    base_model = EfficientNetB3(include_top=False, weights='imagenet', input_shape=(300, 300, 3), input_tensor=inputs)
...
def main():
    ...
    train_ds = tf.keras.utils.image_dataset_from_directory(train_dir, color_mode='rgb', labels='inferred',label_mode ='categorical',
                                                           ...
                                                           image_size=(300, 300), seed=1, validation_split=0.2)
